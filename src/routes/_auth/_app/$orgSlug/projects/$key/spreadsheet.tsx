...
interface SpreadsheetSearch {
  sprint?: string;
}

export const Route = createFileRoute("/_auth/_app/$orgSlug/projects/$key/spreadsheet")({
  component: SpreadsheetPage,
  validateSearch: (search: Record<string, unknown>): SpreadsheetSearch => ({
