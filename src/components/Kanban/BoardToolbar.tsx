...
export function BoardToolbar({
  ...
  return (
    <Card
      ...
      padding="none"
      className="pointer-events-auto absolute right-2 top-2 z-20 mb-0 w-fit max-w-full sm:static sm:mx-6 sm:mt-4 sm:mb-0 sm:max-w-none"
    >
      <Flex
        align="center"
        justify="between"
        gap="xs"
        className="px-1.5 py-1 sm:gap-sm sm:px-5 sm:pb-3 sm:pt-4"
      >
        ...
        {showControls && (
          ...
          >
            ...
            {/* Undo/Redo buttons */}
            <Flex align="center" gap="xs" className="mr-2 hidden sm:flex sm:mr-4">
