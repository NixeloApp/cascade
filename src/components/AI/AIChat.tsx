        ...
        {message.role === "assistant" && (
          <Tooltip content="Copy message">
            <Button
              ...
              className="absolute -right-2 -top-2 h-8 w-8 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity shadow-sm hover:shadow-md border border-ui-border bg-ui-bg"
