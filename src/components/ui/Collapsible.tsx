  ...
  return (
    <CollapsiblePrimitive.Trigger
      ...
      className={cn(
        ...
        "transition-all duration-default ease-out hover:bg-ui-bg-hover rounded-md px-2 py-1.5",
...
function CollapsibleHeader({
  ...
  return (
    <CollapsibleTrigger className={cn("-mx-2", className)} {...props}>
      ...
      {!hideChevron && (
        <ChevronDown className="w-4 h-4 shrink-0 text-ui-text-tertiary transition-transform duration-default group-data-[state=open]:rotate-180" />
      )}
    </CollapsibleTrigger>
  );
}
