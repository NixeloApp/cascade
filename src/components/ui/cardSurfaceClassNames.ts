/**
 * Feature-owned card surface class names.
 *
 * The shared Card primitive owns only the semantic base surface. This module
 * contains the narrower helper lookup used by existing feature surfaces.
 */

export const cardRecipeClassNames = {
  ...
  documentSidebarInfoRow: "rounded-none border-transparent bg-transparent px-0 py-1 shadow-none",
  documentCommentComposer:
    "rounded-none border-x-0 border-b-0 border-t border-ui-border bg-transparent shadow-none",
  documentTreeRow: "rounded-md border-transparent bg-transparent shadow-none hover:bg-ui-bg-hover",
  ...
  dragPreview: "rounded-lg border-brand bg-brand-subtle px-2 py-2 text-sm text-brand shadow-soft",
  selectionRow:
  ...
  onboardingInviteBullet: "rounded-full border-transparent bg-brand-subtle text-brand shadow-none",
  onboardingRoleCard:
  ...
  onboardingActionIconBrand: "rounded-lg border-transparent bg-brand-subtle text-brand shadow-none",
  ...
  onboardingChecklistHero: "rounded-lg border-transparent bg-brand-subtle text-brand shadow-none",
  ...
  statusError: "rounded border-transparent bg-status-error-bg text-status-error-text shadow-none",
  ...
  sidebarNavIcon: "rounded-lg border-ui-border/60 bg-ui-bg-soft text-ui-text-tertiary shadow-none",
  sidebarPrimaryNavIcon:
    "rounded-xl border-ui-border/60 bg-ui-bg-soft text-ui-text-tertiary shadow-none",
  sidebarPrimaryNavIconActive: "rounded-xl border-brand/20 bg-brand-subtle text-brand shadow-none",
  sidebarSectionIcon:
  ...
  sidebarTeamStatus: "ml-6 rounded-none border-transparent bg-transparent px-3 py-1 shadow-none",
  ...
  searchDropdown: "overflow-hidden rounded-md border-ui-border bg-ui-bg-elevated shadow-elevated",
  searchResultRow:
  ...
  calendarWeekdayHeaderCell: "rounded-none border-transparent bg-transparent px-2 py-2 shadow-none",
  ...
  versionHistoryEntrySelected: "rounded-container border-brand-ring bg-brand-subtle shadow-soft",
...
export type CardRecipe = keyof typeof cardRecipeClassNames;

export function getCardRecipeClassName(recipe: CardRecipe): string {
  return cardRecipeClassNames[recipe];
}
