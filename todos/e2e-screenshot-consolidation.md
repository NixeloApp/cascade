...
- [ ] Keep shrinking direct screenshot-lib route-driving so ordinary canonical/modal captures go through page-object navigation, leaving explicit blocked-query loading captures as the only justified exception.
