...
|----------|------|----------------|
| P1 | [screenshot-facelift-overhaul.md](./screenshot-facelift-overhaul.md) | Screenshot residue: 6 page spec folders missing canonical variants, 3 spec'd modal sets missing canonical variants, deeper modal/interactive-state coverage, CI manifest workflow |
