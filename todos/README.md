...
|----------|------|----------------|
| P1 | [screenshot-facelift-overhaul.md](./screenshot-facelift-overhaul.md) | Screenshot residue: deeper modal/interactive-state coverage, CI manifest workflow |
| P1 | [visual-consistency-hardening.md](./visual-consistency-hardening.md) | Broader consistency system is in place; cleanup remains for 68 Typography drift points, 49 control-chrome drift points, and residual screenshot/state cohesion gaps |
