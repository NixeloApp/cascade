...
- [ ] [visual-consistency-hardening.md](./visual-consistency-hardening.md) — Screenshot-driven product polish and human review debt; dashboard, outreach, documents, issues, my-issues, notifications, roadmap, time tracking, project inbox, workspaces, org calendar, project analytics, org analytics, and assistant state coverage are now in-spec, but broader page-by-page cleanup remains.
...
| App tests (`vitest run`) | 4638 pass / 3 skipped |
| Convex tests (`vitest.convex`) | 2116 pass / 3 skipped |
| Page spec triplets | 42/42 present |
| Screenshot harness shell (`filled-states.ts`) | 2111 lines |
| TEST_ID constants / page-object files | 320 / 26 |
