...
|---------|---------|-------|--------|--------|
| **Gantt chart** | — | ✅ Full | ⚠️ Roadmap now has dependency lines, resize handles, draggable date-range bars, real month/week timeline buckets, timeline window navigation, zoom controls, group-by sections, and collapsible swimlanes; still lacks full dedicated Gantt experience | High — standard PM expectation |
