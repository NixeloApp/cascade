...
|----------|------|----------------|
| P1 | [visual-consistency-hardening.md](./visual-consistency-hardening.md) | Broader consistency system is in place; cleanup remains for 47 Typography drift points, 16 control-chrome drift points, and residual screenshot/state cohesion gaps |
