...
|----------|------|------|------------|
| P2 | [cal-com-features.md](./cal-com-features.md) | Port features from Cal.com v6.3 | 7 items: AI agents, OOO calendar follow-through, cancellation reasons, workflow translation, custom domain/SMTP, branding |
...
| **OOO status** | ✅ Full API | — | ⚠️ Profile + assignee visibility + issue delegation shipped; calendar integration missing | High — affects calendar, assignments, notifications |
