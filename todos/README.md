...
|---------|---------|-------|--------|--------|
| **Gantt chart** | — | ✅ Full | ⚠️ Roadmap now has dependency lines, resize handles, draggable date-range bars, real month/week timeline buckets, and group-by sections; still lacks full dedicated Gantt experience | High — standard PM expectation |
