...
- [ ] [visual-consistency-hardening.md](./visual-consistency-hardening.md) — Screenshot-driven product polish and human review debt; outreach, documents, issues, my-issues, notifications, project inbox, and workspaces empty/interaction states are now in-spec, but broader page-by-page cleanup remains.
...
| Screenshot harness shell (`filled-states.ts`) | 1771 lines |
| TEST_ID constants / page-object files | 273 / 24 |
