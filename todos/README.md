...
|----------|------|----------------|
| P1 | [visual-consistency-hardening.md](./visual-consistency-hardening.md) | Broader consistency system is in place; cleanup remains for 65 Typography drift points, 21 control-chrome drift points, and residual screenshot/state cohesion gaps |
