...
- [ ] [visual-consistency-hardening.md](./visual-consistency-hardening.md) — Screenshot-driven product polish and human review debt; the shared page header/content shell cleanup is now in, dashboard/projects/invoices/outreach/documents/issues/my-issues/notifications/roadmap/time-tracking/project-inbox/workspaces/org-calendar/project-analytics/org-analytics/assistant coverage is now in-spec, but broader page-by-page cleanup remains.
