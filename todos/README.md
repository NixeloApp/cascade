...
- [ ] [visual-consistency-hardening.md](./visual-consistency-hardening.md) — Screenshot-driven product polish and human review debt; outreach, documents, issues, notifications, project inbox, and workspaces empty/interaction states are now in-spec, but broader page-by-page cleanup remains.
...
| App tests (`vitest run`) | 4618 pass / 3 skipped |
| Convex tests (`vitest.convex`) | 2116 pass / 3 skipped |
| Page spec triplets | 42/42 present |
| Screenshot harness shell (`filled-states.ts`) | 1760 lines |
| TEST_ID constants / page-object files | 265 / 23 |
