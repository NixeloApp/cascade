...
|---------|---------|-------|--------|--------|
| **Gantt chart** | — | ✅ Full | ⚠️ Roadmap now has dependency lines, resize handles, draggable date-range bars, and real month/week timeline buckets; still lacks full dedicated Gantt experience | High — standard PM expectation |
