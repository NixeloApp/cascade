...
|---|---|---:|---|---|
| P0 | [e2e-reliability-overhaul.md](./e2e-reliability-overhaul.md) | `11/33` | In Progress | Finish deterministic waits/selectors, trim retry-heavy helpers, and keep local full suite green |
