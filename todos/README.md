...
- [ ] [p0-outreach-holes.md](./p0-outreach-holes.md) — Outreach still has real launch blockers: no frontend UI, mailbox-level rate limiting/bounce hardening, and missing send-pipeline integration coverage.
...
| App tests (`vitest run`) | 4555 pass / 5 skipped |
| Convex tests (`vitest.convex`) | 2110 pass / 3 skipped |
