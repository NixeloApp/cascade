...
|----------|------|----------------|
| P1 | [screenshot-facelift-overhaul.md](./screenshot-facelift-overhaul.md) | Screenshot residue: 1 page spec folder missing canonical variants, deeper modal/interactive-state coverage, CI manifest workflow |
