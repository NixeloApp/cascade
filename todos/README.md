...
- [ ] [visual-consistency-hardening.md](./visual-consistency-hardening.md) — Screenshot-driven product polish and human review debt; outreach dialog/destructive coverage is now reviewed, but broader page-by-page cleanup remains.
