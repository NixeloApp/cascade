...
- [ ] roll the shared page-controls rhythm across the remaining settings and admin surfaces that still hand-roll header-following tabs, filters, or secondary actions
