...
- [ ] finish the admin controls-band rollout inside the remaining heavy admin subpanels that still hand-roll local tabs, filters, or action bars, especially user management and hour compliance
