...
- [ ] Add validator coverage for section-specific `index.css`/global CSS drift -- page-specific named classes should be rare and justified, not a fallback for avoiding Tailwind or primitive ownership
