...
- [~] **Evaluate Gantt implementation** — Our roadmap now supports draggable bars, resize handles, dependency lines, real month/week timeline buckets, and group-by sections, but still needs fuller Gantt affordances (sidebar polish/collapse behavior).
