...
export const RAW_TAILWIND_STRUCTURAL_ALLOWLIST = [
  ...
  /\banimate-(?:fade-in|fade-out|slide-up|slide-down|scale-in|scale-out|enter-right|enter-left|exit-right|exit-left|slide-up-out|slide-down-out|flow-1|flow-2|flow-3|in|out)\b/,
