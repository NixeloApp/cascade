...
describe("User Sanitization Utils", () => {
  ...
  describe("getUserName", () => {
    ...
    it("should return custom default if user is null/undefined or missing fields", () => {
      expect(getUserName(null, "Custom Default")).toBe("Custom Default");
      expect(getUserName({} as any, "Custom Default")).toBe("Custom Default");
    });
  });
});
