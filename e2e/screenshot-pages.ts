...
import {
  ...
  waitForIssueDetailReady,
  waitForIssuesReady,
  waitForProjectsReady,
  waitForRoadmapReady,
  waitForSpinnersHidden,
  waitForTeamDetailReady,
  waitForWorkspaceBacklogReady,
  waitForWorkspacesReady,
} from "./screenshot-lib/readiness";
...
// Page readiness helpers extracted to ./screenshot-lib/readiness.ts

// Discovery, document, issue draft, and auth helpers extracted to ./screenshot-lib/helpers.ts

// ---------------------------------------------------------------------------
// Screenshot passes
// ---------------------------------------------------------------------------

// Public pages and empty states extracted to ./screenshot-lib/public-pages.ts
