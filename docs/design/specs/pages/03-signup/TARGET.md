# Sign Up Page - Target State

> **Route**: `/signup`
> **Reference**: Mintlify auth pages
> **Goal**: Minimal, confident, premium (mirrors signin)
...
| Create account | 48px | `bg-brand` | none |
...
Show ONLY when email form is expanded (step >= 1):
